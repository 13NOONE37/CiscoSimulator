        ...
        <div className="systemTimeBox">
          <span>
            <input
              ...
              onChange={(e) => handleGlobalChange(e, setcurrentTimeSource)}
            />
            Manual
            ...
            <form onSubmit={handleSubmit} className="tplinkFormBase1">
              ...
              <span>
                ...
                <ReactInputMask
                  ...
                  maskChar={' '}
                  value={firstServer}
                  onChange={(e) => handleGlobalChange(e, setfirstServer)}
                ></ReactInputMask>
                <input
                  type="submit"
              ...
              <span>
                ...
                <ReactInputMask
                  ...
                  maskChar={' '}
                  value={secoundServer}
                  onChange={(e) => handleGlobalChange(e, setsecoundServer)}
                ></ReactInputMask>
                <input
                  type="submit"
                  className="moveRight buttonPointer"
              ...
              <span>
                ...
                <input
                  ...
                  type="number"
                  value={updateRate}
                  onChange={(e) => handleGlobalChange(e, setupdateRate)}
                  disabled={currentTimeSource != 'NTP'}
                />
                <input
                  type="submit"
